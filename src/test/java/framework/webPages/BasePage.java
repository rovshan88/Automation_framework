...
//	public List<String> elementLineText() {
//		List<String> elementLine = new ArrayList<>();
//
//		List<WebElement> elementElement = SharedSD.getDriver().findElements(getTextFromElement());
//
...
//		for (String element : elementLineText()) {
//			tempNumbers.add(Integer.valueOf(element.substring(0, element.length() - 1)));
//		}
//		return tempNumbers;
//	}
//}
